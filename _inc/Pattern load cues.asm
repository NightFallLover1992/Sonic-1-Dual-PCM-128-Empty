...
; Note: Everything aside from the main tile set and springs/spikes have been commented out. You can add them back if you want
; ---------------------------------------------------------------------------
PLC_GHZ:	dc.w 3	; UT: Make sure that if you change the amount of stuff being used, make sure to change this value!
